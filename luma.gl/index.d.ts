...
declare module 'luma.gl/webgl/shader' {
	...
	export class Shader extends Resource {
	    ...
	    constructor(gl: any, source: any, shaderType: any);
	    initialize({ source }: {
	        source: any;
	    }): void;
...
declare module 'luma.gl/webgl/program' {
	...
	export function getUniformDescriptors(gl: any, program: any): {};
...
declare module 'luma.gl/webgl/draw' {
	export function draw(gl: any, { drawMode, vertexCount, offset, isIndexed, indexType, isInstanced, instanceCount }: {
	    drawMode?: number;
	    vertexCount: any;
	    offset?: number;
	    isIndexed?: boolean;
...
declare module 'luma.gl/webgl/functions' {
	 ...
	 */
	export function readPixels(gl: any, { x, y, width, height, data, dataOffset, type, sourceHeight, format }: {
	    x: any;
	    y: any;
	    width?: number;
	    height?: number;
	 ...
	 */
	export function readPixelsToBuffer(gl: any, { x, y, width, height, buffer, dataOffset, type, sourceHeight, format }: {
	    x: any;
	    y: any;
	    width?: number;
	    height?: number;
	...
	export function blitFramebuffer(gl: any, { source: [sourceX, sourceY, sourceWidth, sourceHeight], dest: [destX, destY, destWidth, destHeight], mask, filter }: {
...
declare module 'luma.gl/webgl/query' {
	...
	export default class Query extends Resource {
	    static isSupported(gl: any, { queries, timers, timestamps }?: {
	        queries?: boolean;
	        timers?: boolean;
	        timestamps?: boolean;
	    }): any;
...
declare module 'luma.gl/shadertools/lib/platform-defines' {
	...
	export function getVersionDefines(gl: any): string;
...
declare module 'luma.gl/core/pick-models' {
	export default function pickModels(gl: any, { models, position, uniforms, // eslint-disable-line
...
declare module 'luma.gl/index' {
	...
	default as GL } from 'luma.gl/constants';
	export { // Should be optional import for application
	glGet, glKey } from 'luma.gl/deprecated/gl-constants';
