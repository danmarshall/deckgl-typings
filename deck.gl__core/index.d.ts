...
declare module '@deck.gl/core/passes/layers-pass' {
	...
	export default class LayersPass extends Pass {
		...
		_drawLayersInViewport(gl: any, { layers, layerFilter, onError, viewport, view, pass, effects, moduleParameters }: {
			layers: any;
			layerFilter: any;
			onError: any;
			viewport: any;
...
declare module '@deck.gl/core/lib/deck-picker' {
	export default class DeckPicker {
		...
		_resizeBuffer(): any;
		_pickClosestObject({ layers, viewports, x, y, radius, depth, mode, unproject3D, onViewportActive }: {
			layers: any;
			viewports: any;
			x: any;
			y: any;
...
declare module '@deck.gl/core/lib/deck' {
	...
	export interface DeckProps {
		...
		getTooltip?: <D>(info: PickInfo<D>) => null |
		{
			text?: string;
			html?: string;
			className?: string;
		...
		onViewStateChange?: (args: { viewState: any, interactionState: { inTransition?: boolean, isDragging?: boolean, isPanning?: boolean, isRotating?: boolean, isZooming?: boolean }, oldViewState: any }) => any;
